    ...
    return (
        <div className={styles.flexContainer}>
            <div className={styles.container}>
                ...
                >
                    {projects[projectIndex].src ? (
                        <img
                            src={projects[projectIndex].src}
                            alt="Project GIF"
                            className="project-gif"
                            onLoad={(e) => e.target.style.visibility = 'visible'} // Show when loaded
                            style={{ visibility: 'hidden' }} // Initially hidden
                        />
                    ) : (
                        <div className="project-placeholder">No Image Available</div> // Placeholder when no image
                    )}
